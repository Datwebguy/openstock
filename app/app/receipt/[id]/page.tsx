  ...
  return (
    <main className="page">
      ...
      <div className="app-page container">
        <PaperReceipt id={id} />
        <div className="receipt-actions" style={{ display: "flex", gap: 12, marginTop: 24 }}>
          <Link className="button button--gradient" href="/app">
            Back to Market
          </Link>
          <Link className="button button--light" href="/app/orders">
            View Orders Desk
          </Link>
          <Link className="button button--outline" href="/app/activity">
            View Activity
          </Link>
        </div>
      </div>
