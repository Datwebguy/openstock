...
export interface SolanaLogoMarkProps {
  size?: number;
  className?: string;
...
/**
 * Official Solana Logo Mark as a transparent-background SVG.
 * Does not redraw or modify official geometry.
 */
export function SolanaLogoMark({
  size = 24,
  className,
  style,
  opacity,
